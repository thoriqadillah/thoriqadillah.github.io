...
```
That's it! That is basically how to animate a terminal. But let's compare the speed of these two, how much time elapsed when executing the native and the optimal with the code below
...
func main() {
  ...
  fmt.Println()
  fmt.Println(elapsedNative.Microseconds())
